          ...
          children: [
            Container(
              ...
              child: GridView.builder(
                ...
                itemCount: trendingthisalltopsix != null && trendingthisalltopsix['response'] != null
                    ? trendingthisalltopsix['response'].length
                    : 0,
                ...
                itemBuilder: (BuildContext context, int index) {
                  if (index >= trendingthisalltopsix['response'].length) return Container(); // Avoid out of range error
                  return InkWell(
                    onTap: () async {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => TrendingInnerPage(
                            id: trendingthisalltopsix['response'][index]['_id'],
