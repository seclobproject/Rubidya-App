      ...
      body: Column(
        ...
        children: [
          ...
          Align(
            alignment: Alignment.center,
            child: Text(
              "\₹${widget.amount ?? 'N/A'}", // Display the amount here
              style: TextStyle(
                fontSize: 25,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text( ' ${deductedAmount.isEmpty ? "N/A" : deductedAmount}',style: TextStyle(color: white,fontWeight: FontWeight.w700,fontSize: 24),),
