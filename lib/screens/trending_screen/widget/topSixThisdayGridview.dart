...
class TopSixGridviewday extends StatefulWidget {
  @override
      ...
      itemBuilder: (BuildContext context, int index) {
        return GestureDetector(
          onTap: () async {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => trendinginnerpage(id: trendingthisdaytopsix['response'][index]['_id'],)),);
          },
          child: Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: trendingthisdaytopsix['response'][index]['profilePic'] != null
                              ? NetworkImage(trendingthisdaytopsix['response'][index]['profilePic'])
                              : null,
                          child: trendingthisdaytopsix['response'][index]['profilePic'] == null
                              ? Icon(Icons.person, size: 30, color: Colors.white) // Optionally add an icon or placeholder
                              : null,
                        ),
                  ...
                  Container(
                    height: 15,
                    child: Text(
                      trendingthisdaytopsix['response'][index]['userName'],
                      style: TextStyle(
                        fontSize: 11,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        trendingthisdaytopsix['response'][index]['totalPoints'].toString(),
                        style: TextStyle(
                          fontSize: 9,
                          fontWeight: FontWeight.w500,
                          color: Colors.white,
