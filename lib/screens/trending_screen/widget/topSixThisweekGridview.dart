...
class TopSixGridviewweek extends StatefulWidget {
  @override
  _TopSixGridviewweek createState() => _TopSixGridviewweek();
}

class _TopSixGridviewweek extends State<TopSixGridviewweek> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                              trendingthisweektopsix['response'][index]['profilePic']),
                        ),
                      ),
                      Positioned(
                        top: 70,
