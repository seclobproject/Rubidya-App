...
class TrendingListAll extends StatefulWidget {
  @override
  State<TrendingListAll> createState() => _TrendingListState();
}

class _TrendingListState extends State<TrendingListAll> {
  String? userid;
  var trendingprice;
  ...
  Future<void> _trendingcarddetailsapi() async {
    ...
    if (userid != null) {
      var response = await TrendingService.trendingapiThisall(page: _pageNumber);
  ...
  Future<void> _loadMoreData() async {
    ...
    try {
      final response = await TrendingService.trendingapiThisall(page: _pageNumber + 1);
