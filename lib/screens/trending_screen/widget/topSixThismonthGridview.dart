...
class TopSixGridviewmonth extends StatefulWidget {
  @override
  _TopSixGridviewmonthState createState() => _TopSixGridviewmonthState();
}

class _TopSixGridviewmonthState extends State<TopSixGridviewmonth> {
  ...
  Future _trendingtopSixapithismonth(String status) async {
    ...
    try {
      ...
      log.i('tranding by week .. $response');
      setState(() {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                              trendingthismonthtopsix['response'][index]['profilePic']),
                        ),
                      ),
                      Positioned(
                        top: 70,
