    ...
    return _isLoading
      ...
      itemBuilder: (BuildContext context, int index) {
        return GestureDetector(
          onTap: () async {
            String userName = trendingthismonthtopsix['response'][index]['userName'];
            String userId = trendingthismonthtopsix['response'][index]['userId'];
            var profile_pic_url = trendingthismonthtopsix['response'][index]['profilePic'];
